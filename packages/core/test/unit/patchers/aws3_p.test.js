...
const awsPatcher = require('../../../lib/patchers/aws3_p');
const contextUtils = require('../../../lib/context_utils');
const Segment = require('../../../lib/segments/segment');
const Utils = require('../../../lib/utils');

const { constructStack } = require('@aws-sdk/middleware-stack');
...
describe('AWS v3 patcher', function () {
  ...
  describe('#captureAWSRequest', function () {
    let awsClient, awsRequest, sandbox, segment, stubResolve, addNewSubsegmentStub, sub;
