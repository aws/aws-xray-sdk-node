...
const SegmentEmitter = require('../../../lib/segment_emitter')
...
const Lambda = require('../../../lib/env/aws_lambda')
const Context = require('../../../lib/context_utils')
...
describe('Segment', function () {
  describe('#init', function () {
    ...
    it('should generate a new trace id if one was not supplied', function () {
      ...
      const expected = new RegExp('^1-([a-f0-9]{8})-([a-f0-9]{24})$')
    ...
    it('should use SegmentUtils pluginData properties call addPluginData', function () {
      ...
      const stubAddPluginData = sandbox.stub(Segment.prototype, 'addPluginData')
      new Segment('foo')
    ...
    it('should use SegmentUtils sdkData properties call setSDKData', function () {
      ...
      const stubSetSDKData = sandbox.stub(Segment.prototype, 'setSDKData')
      new Segment('foo')
    ...
    it('should use SegmentUtils serviceData properties call setServiceData', function () {
      const serviceData = '2.3.0'
      SegmentUtils.setServiceData(serviceData)
      const stubSetServiceData = sandbox.stub(Segment.prototype, 'setServiceData')
      new Segment('foo')
  ...
  describe('#addSubsegment', function () {
    let incrementStub, subsegment, sandbox, segment
  ...
  describe('#addError', function () {
    let err, exceptionStub, sandbox, segment
  ...
  describe('#close', function () {
    let err, addErrorStub, flushStub, sandbox, segment
  ...
  describe('#incrementCounter', function () {
    ...
    it('should stream the subsegments when the count is greater than the SegmentUtils threshold', function () {
      ...
      const child1 = segment.addNewSubsegment('child1')
      const child2 = segment.addNewSubsegment('child2')
      const stubStream1 = sandbox.stub(child1, 'streamSubsegments')
    ...
    it('should remove the subsegments streamed from the subsegments array', function () {
      ...
      const child1 = segment.addNewSubsegment('child1')
      const child2 = segment.addNewSubsegment('child2')
      const child3 = segment.addNewSubsegment('child3')
      const child4 = segment.addNewSubsegment('child4')
      const child5 = segment.addNewSubsegment('child5')
      const child6 = segment.addNewSubsegment('child6')
  ...
  describe('#flush', function () {
    ...
    describe('if traced', function () {
      it('should remove properties "notTraced", "counter" and "exception"', function () {
        const sendStub = sandbox.stub(SegmentEmitter, 'send')
        ...
        const sentSegment = sendStub.lastCall.args[0]
